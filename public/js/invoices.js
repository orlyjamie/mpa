$(document).ready(function() {
    ...
    function getMemberDets(item){
        window.location.href = 'http://localhost/~allanhyde/authentication/public/invoices/name/' + item;
    }
    ...
    $("#export_invoices").click(function() {
        ...
        if(sel_inv.length > 0) {
           ...
           // alert("error");
            ...
            var errorUrl = "http://localhost/~allanhyde/authentication/public/invoices/errors";
