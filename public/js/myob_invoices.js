function updateInvoiceDetails(id, UID, num, rowVersion, exportType, numInvoices, thisInvoice){
    ...
    $.ajax({
        ...
        url: 'http://localhost/~allanhyde/authentication/public/invoices/myob_update',
...
function exportInvoice(invoiceId, payload, exportType, InvUID, numInvoices, thisInvoice){
    ...
    $.ajax({
         ...
         url: 'http://localhost/~allanhyde/authentication/public/invoices/myob_export',
         success: function (data) {
            console.log(data);
...
function prepExportInvoice(invoiceId, numInvoices, thisInvoice){
    ...
    */
    ...
    var prepInvExportUrl = "http://localhost/~allanhyde/authentication/public/invoices/prep/" + invoiceId;
