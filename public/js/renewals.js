$(document).ready(function() {
    ...
    $("#cancel_add").click(function() {
        ...
        window.location.replace("http://localhost/~allanhyde/authentication/public/members/list/" + status + "/" + name);
    ...
    $("#renewal_email").click(function() {
        ...
        window.location.href = 'http://localhost/~allanhyde/authentication/public/members/renewals/email/';
    ...
    $("#save_contact").click(function() {
        ...
        $.ajax({
            url: "http://localhost/~allanhyde/authentication/public/members/contacts/add/1",
            type: "post",
            //data: csrfData ,
            success: function (response) {
                ...
                //window.location.href = 'http://localhost/~allanhyde/authentication/public/';
            },
    ...
    */
            ...
            buttons: {
                ...
                "Save": function () {
                    ...
                    if ($("#contact_form").valid()) {
                        ...
                        $.ajax({
                            url: "http://localhost/~allanhyde/authentication/public/members/contacts/add/" + memberID,
                            type: "post",
                            data: datastring,
                            success: function (response) {
    ...
    $("[id^=edit_contact_]").click(function(event) {
        ...
        $.ajax({
            url: "http://localhost/~allanhyde/authentication/public/members/contacts/get/" + contactID,
            type: "get",
            data: csrfData ,
            success: function (response) {
                        ...
                        buttons: {
                            ...
                            "Save": function () {
                                ...
                                if ($("#contact_form").valid()) {
                                    ...
                                    $.ajax({
                                        url: "http://localhost/~allanhyde/authentication/public/members/contacts/edit/" + contactID,
                                        type: "post",
                                        data: datastring,
                                        success: function (response) {

                                            //alert("RESP: " + JSON.stringify(response));
                                            window.location.href = 'http://localhost/~allanhyde/authentication/public/members/edit/1';
                                        },
                                        error: function (jqXHR, textStatus, errorThrown) {
                                            console.log(textStatus, errorThrown);
                                            alert("Got some error: " + errorThrown);
