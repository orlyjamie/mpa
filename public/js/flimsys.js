$(document).ready(function() {
    ...
    function getMemberDets(item){
        ...
        $.ajax({
            url: 'http://localhost/~allanhyde/authentication/public/flimsys/member/' + item,
            type: "GET",
    ...
    $("#ordered_by").change(function(){
        ...
        $.ajax({
            url: 'http://localhost/~allanhyde/authentication/public/flimsys/contact/' + contact,
            type: "GET",
            success: function (response) {
    ...
    $("#cancel_add").click(function(){
        window.location.replace("http://localhost/~allanhyde/authentication/public/flimsys");
    });
    ...
    $("#cancel_edit").click(function(){
        ...
        if(updateSource == 'F'){
            ...
            if(getCustomerName.length > 0) {
                window.location.replace('http://localhost/~allanhyde/authentication/public/invoices/name/' + getCustomerName + '');
            } else {
                window.location.replace('http://localhost/~allanhyde/authentication/public/invoices');
            }
        }
    });
    ...
    function updateFlimsyInvoice(Id, source){
        ...
        var flimsyUpdateUrl = 'http://localhost/~allanhyde/authentication/public/flimsys/order/' + Id;
    ...
    $("#submit_flimsy").click(function() {
        ...
        if(mode == 'add') {
            var flimsyUpdateUrl = 'http://localhost/~allanhyde/authentication/public/flimsys/add';
        } else if(mode == 'edit'){
            var flimsyUpdateUrl = 'http://localhost/~allanhyde/authentication/public/flimsys/edit/' + flimsyId;
        }
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if(response == 'errors'){
                    //$.unblockUI();
                    if(mode == 'edit') {
                        window.location.replace('http://localhost/~allanhyde/authentication/public/flimsys/get/' + flimsyId + "/" + source + "/" + payment_status);
                    } else if(mode == 'add') {
                        window.location.replace('http://localhost/~allanhyde/authentication/public/flimsys/new');
                    }
                } else {
    ...
    */
    ...
    $("[id^=process_payment_]").click(function(event){
        ...
        if(paymentMethod == 'C'){
            ...
            var flimsyOrderUrl = 'http://localhost/~allanhyde/authentication/public/flimsys/order/' + requestId;
