$(document).ready(function() {
    ...
    $("[id^=submit_stakeholder_]").click(function() {
        ...
        if(mode == 'edit') {
            ...
            var memberUpdateUrl = "http://localhost/~allanhyde/authentication/public/stakeholder/edit/" + memberID;
        } else if(mode == 'add') {
            //alert("adding");
            var memberUpdateUrl = "http://localhost/~allanhyde/authentication/public/stakeholder/add/";
        }
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if(response == 'errors'){
                    if(mode == 'edit') {
                        window.location.replace('http://localhost/~allanhyde/authentication/public/members/stakeholders/' + memberID);
                    } else if(mode == 'add') {
                        window.location.replace('http://localhost/~allanhyde/authentication/public/stakeholder/new');
                    }
                } else {
                    ...
                    if (next == 'errors') {
                        if (mode == 'edit') {
                            window.location.replace('http://localhost/~allanhyde/authentication/public/stakeholders/edit/' + memberID);
                        } else {
                            window.location.replace('http://localhost/~allanhyde/authentication/public/stakeholder/add');
                        }
                    } else if (next == 'ok') {
                        if (mode == 'add') {
    ...
    $("#cancel_add").click(function() {
        ...
        if(getTradingName.length > 0) {
            window.location.replace('http://localhost/~allanhyde/authentication/public/stakeholder/name/' + getTradingName + '');
        } else {
