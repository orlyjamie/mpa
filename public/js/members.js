$(document).ready(function() {
    ...
    $("[id^=submit_member_]").click(function() {
        ...
        if(mode == 'edit') {
            ...
            var memberUpdateUrl = "http://localhost/~allanhyde/authentication/public/members/edit/" + memberID;
        } else if(mode == 'add') {
            //alert("adding");
            var memberUpdateUrl = "http://localhost/~allanhyde/authentication/public/members/add/";
        }
        ...
        $.ajax({
            ...
            success: function (response) {
                if(response == 'errors'){
                    //$.unblockUI();
                    if(mode == 'edit') {
                        window.location.replace('http://localhost/~allanhyde/authentication/public/members/edit/' + memberID);
                    } else if(mode == 'add') {
                        window.location.replace('http://localhost/~allanhyde/authentication/public/members/new');
                    }
                } else {
                    ...
                    if (next == 'errors') {
                        if (mode == 'edit') {
                            ...
                            window.location.replace('http://localhost/~allanhyde/authentication/public/members/add');
                        }
                    } else if (next == 'ok') {
                        if (mode == 'add') {
                            updateMyobCustomer(membersFilter, mode, memberId);
                        } else if (mode == 'edit') {
                            updateMyobCustomer(membersFilter, mode, memberID);
                        }
                    }
    ...
    function updateMyobCustomer(filter, mode, memberId){
        //CHECK FOR AN MYOB CONNECTION
        testConnection(mode, memberId);
    }
