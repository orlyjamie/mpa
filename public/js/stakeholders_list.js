$(document).ready(function() {
    ...
    function getMemberDets(item){
        //alert("ITEM: " + item);
        window.location.href = 'http://localhost/~allanhyde/authentication/public/members/name/' + item;
    }
    ...
    function filterMembers() {
        ...
        window.location.href = 'http://localhost/~allanhyde/authentication/public/members/list/filter?types=' + selected_status;
    }
